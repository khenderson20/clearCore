...
constexpr uint32_t ADDI=0x08,ADDIU=0x09,ORI=0x0D,LUI=0x0F,
...
constexpr uint32_t zero=0,v0=2,a0=4,
                   t0=8,t1=9,t2=10,t3=11,t4=12,t5=13,t6=14,t7=15,s0=16,ra=31;
} // namespace enc
...
static void run_on_both(Fn&& fn, const char* name) {
    SingleCycleCpu sc;
...
int main() {
    ...
    { SingleCycleCpu sc; test_pipeline_state_single(sc); }
    { PipelinedCpu   pl; test_pipeline_state_pipelined(pl); }
